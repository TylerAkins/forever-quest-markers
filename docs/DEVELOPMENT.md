...
| `tools/build_wowhead_db.py` | Wowhead Forever → `data/wowhead/` (future ATT replacement) |
| `data/wowhead/` | Wowhead quest index + details (see `docs/wowhead-quest-database.md`) |
