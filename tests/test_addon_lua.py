...
class AddonLuaTests(unittest.TestCase):
    ...
    def test_auto_quest_options(self) -> None:
        ...
        self.assertIn("function LookupSaved()", config)
        self.assertIn("rawget(env, SV_NAME)", config)
        self.assertIn("function ns.FlushSettings()", config)
        self.assertIn("RegisterAddOnSetting", config)
        self.assertIn("RegisterVerticalLayoutCategory", config)
        self.assertIn("Settings.CreateCheckbox", config)
        ...
        self.assertIn("LookupSaved()", hydrate)
        self.assertNotIn("ForeverQuestPinsDB_Settings =", hydrate)
        ...
        self.assertIn("ns.HydrateSettings()", login)
        ...
        pew_end = core.find('if event == "PLAYER_LOGOUT" then', pew_at)
        pew = core[pew_at:pew_end]
        self.assertIn("ns.InitSettings()", pew)
        self.assertIn("ns.TryRegisterSettings()", pew)
