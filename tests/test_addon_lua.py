...
class AddonLuaTests(unittest.TestCase):
    ...
    def test_player_docs_are_complete(self) -> None:
        ...
        self.assertIn("New installs do not need to touch SavedVariables files", readme)
    ...
    def test_auto_quest_options(self) -> None:
        ...
        self.assertIn("function ns.InitSettings(allowCreate)", config)
        self.assertIn("function ns.FlushSettings()", config)
        self.assertIn("function ns.WipeSettings()", config)
        self.assertIn("function ns.ResolveSettings()", config)
        self.assertIn("ApplyDirty", config)
        self.assertIn("BindSavedTable", config)
        self.assertIn("SyncPersistedOptions", config)
        self.assertIn("ForeverQuestPinsCharacterSettings", config)
        self.assertIn("if type(character) == \"table\" and character[key] ~= nil then", config)
        ...
        self.assertIn("Do not assign the TOC SavedVariables global before ADDON_LOADED", config)
        ...
        self.assertIn("ns.InitSettings(false)", loaded)
        ...
        self.assertIn("ns.InitSettings(true)", login)
        ...
        self.assertIn("ns.InitSettings(true)", pew)
